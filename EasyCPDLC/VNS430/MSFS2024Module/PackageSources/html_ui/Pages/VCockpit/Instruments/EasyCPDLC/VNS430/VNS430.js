class EasyCpdlcVns430 extends BaseInstrument {
    constructor() {
        super();
        this.screen = null;
    ...
    get templateID() {
        return "EasyCPDLC-VNS430";
    }

    connectedCallback() {
        super.connectedCallback();
        this.screen = this.getChildById("vns430-screen");
        this.waiting = this.getChildById("vns430-waiting");
...
registerInstrument("easycpdlc-vns430", EasyCpdlcVns430);
