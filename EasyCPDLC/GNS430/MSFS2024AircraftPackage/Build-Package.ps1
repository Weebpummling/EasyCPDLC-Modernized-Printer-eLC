...
$packageName = 'zzzz-easycpdlc-pmdg-738-gns430'
...
$manifest.title = 'EasyCPDLC GNS 430 for PMDG 737-800'
$manifest.package_version = '0.3.0'
$manifest.release_notes.neutral.LastUpdate =
    'Stock GNS430 model mounted over the printer-panel DZU opening; EasyCPDLC replaces only the LCD.'
...
Write-Host "Built stock-GNS430 package: $resolvedOutputRoot"
