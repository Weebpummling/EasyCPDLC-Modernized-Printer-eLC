...
An experimental [GNS 430-style EasyCPDLC interface](https://github.com/Weebpummling/EasyCPDLC-Modernized-Printer-eLC/tree/testing/gns430-interface) is available on the `testing/gns430-interface` branch. It includes the separate panel, private MSFS 2024 companion-module source, an importable MobiFlight project, test screenshots, and its own setup README.
